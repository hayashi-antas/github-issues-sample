...
### 🏗️ Epic 1: プロジェクトセットアップ (#1)
- [ ] React and Node.jsプロジェクト構成のセットアップ (#2)
- [ ] プロジェクトディレクトリの分割またはモノレポ構成 (#3)
- [ ] Reactアプリの初期化 (#4)
